...
export const AUDIT_ACTIONS = {
  ...
  "lead.fee_agreement_client_signed": { category: "business", actionType: "update", entityType: "fee_agreement", label: "Fee agreement signed by client" },
  "lead.fee_agreement_firm_signed": { category: "business", actionType: "update", entityType: "fee_agreement", label: "Fee agreement counter-signed by firm" },
  "lead.fee_agreement_signer_reassigned": { category: "business", actionType: "update", entityType: "fee_agreement", label: "Fee agreement signer changed" },
