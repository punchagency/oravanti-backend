...
import * as dataAccessService from '../../services/settings/data-access.service';
import { logPermissionChange } from '../../services/settings/permission-audit-log.service';

export const getDataAccessControls = async (req: AuthRequest, res: Response) => {
  try {
...
export const updateDataAccessControls = async (req: AuthRequest, res: Response) => {
  ...
  try {
    ...
    const action = controls.length === 1
