...
export const caseTypeQuestionnaires = pgTable("case_type_questionnaires", {
...
export const caseTypeQuestionnaireSections = pgTable(
  "case_type_questionnaire_sections",
  {
    ...
    questionnaireId: uuid("questionnaire_id")
      .notNull()
      .references(() => caseTypeQuestionnaires.id),
    title: text("title").notNull(),
    description: text("description"),
    orderIndex: integer("order_index").notNull(),
    createdAt: timestamp("created_at").notNull().defaultNow(),
  },
  (table) => [index("ctqs_questionnaire_idx").on(table.questionnaireId)],
);
...
export const caseTypeQuestionnaireQuestions = pgTable(
  "case_type_questionnaire_questions",
  {
    ...
    sectionId: uuid("section_id")
      .notNull()
      .references(() => caseTypeQuestionnaireSections.id),
...
export const caseTypeQuestionnaireLogicRules = pgTable(
  "case_type_questionnaire_logic_rules",
  {
    ...
    sourceQuestionId: uuid("source_question_id")
      .notNull()
      .references(() => caseTypeQuestionnaireQuestions.id),
  ...
  (table) => [index("ctqlr_questionnaire_idx").on(table.questionnaireId)],
);
...
export const firmQuestionnaireSections = pgTable(
  ...
  (table) => [
    unique("fqs_org_case_type_order_unique").on(
...
export const firmQuestionnaireQuestions = pgTable(
  "firm_questionnaire_questions",
  {
    ...
    systemSectionId: uuid("system_section_id").references(
      () => caseTypeQuestionnaireSections.id,
    ),
    firmSectionId: uuid("firm_section_id").references(
      () => firmQuestionnaireSections.id,
    ),
    label: text("label").notNull(),
    description: text("description"),
    type: questionnaireQuestionTypeEnum("type").notNull(),
...
export const firmQuestionnaireLogicRules = pgTable(
  "firm_questionnaire_logic_rules",
  {
    ...
    sourceQuestionId: uuid("source_question_id")
      .notNull()
      .references(() => firmQuestionnaireQuestions.id),
    targetQuestionSource: questionSourceEnum(
...
export const questionnaireSends = pgTable(
  "questionnaire_sends",
  {
    ...
    organizationId: text("organization_id")
      .notNull()
      .references(() => organization.id),
    caseTypeQuestionnaireId: uuid("case_type_questionnaire_id")
      .notNull()
      .references(() => caseTypeQuestionnaires.id),
...
export type CaseTypeQuestionnaireSection =
  typeof caseTypeQuestionnaireSections.$inferSelect;
export type CaseTypeQuestionnaireQuestion =
  typeof caseTypeQuestionnaireQuestions.$inferSelect;
export type CaseTypeQuestionnaireLogicRule =
  typeof caseTypeQuestionnaireLogicRules.$inferSelect;
export type FirmQuestionnaireSection =
  typeof firmQuestionnaireSections.$inferSelect;
export type FirmQuestionnaireQuestion =
  typeof firmQuestionnaireQuestions.$inferSelect;
export type FirmQuestionnaireLogicRule =
  typeof firmQuestionnaireLogicRules.$inferSelect;
