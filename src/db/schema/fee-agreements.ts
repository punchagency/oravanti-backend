...
export const feeAgreementGeneratedFromEnum = pgEnum('fee_agreement_generated_from', [
  'questionnaire_auto',
  'manual',
]);
...
export const feeAgreements = pgTable('fee_agreements', {
  ...
  generatedFrom:  feeAgreementGeneratedFromEnum('generated_from').notNull().default('questionnaire_auto'),
